...
// The compiled-in defaults of the ten hardware parameters (PHASE2_SPEC 4.1), in one place so the
// driver, the README and Phase 6's tools cannot drift apart. Nine are byte-identical to the
// Phase 1 constants they replace; allow_missing_servos is new, and its false is the deliberate
// behaviour change of PHASE2_SPEC 6.
namespace defaults
{

constexpr const char * kPort = "/dev/ttyACM0";        // hpp:128
constexpr int kBaudrate = 1000000;                    // hpp:127
constexpr int kIoTimeoutMs = 20;                      // hpp:137, SCSerial::IOTimeOut
